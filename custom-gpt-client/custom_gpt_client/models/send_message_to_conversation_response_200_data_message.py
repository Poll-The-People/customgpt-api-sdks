...
T = TypeVar("T", bound="SendMessageToConversationResponse200DataMessage")


@attr.s(auto_attribs=True)
class SendMessageToConversationResponse200DataMessage:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        send_message_to_conversation_response_200_data_message = cls(
            id=id,
            user_id=user_id,
        ...
        send_message_to_conversation_response_200_data_message.additional_properties = d
        return send_message_to_conversation_response_200_data_message
