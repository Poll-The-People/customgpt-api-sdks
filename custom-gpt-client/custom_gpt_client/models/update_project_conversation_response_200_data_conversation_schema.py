...
T = TypeVar("T", bound="UpdateProjectConversationResponse200DataConversationSchema")


@attr.s(auto_attribs=True)
class UpdateProjectConversationResponse200DataConversationSchema:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_project_conversation_response_200_data_conversation_schema = cls(
        ...
        update_project_conversation_response_200_data_conversation_schema.additional_properties = d
        return update_project_conversation_response_200_data_conversation_schema
