...
T = TypeVar("T", bound="GetOpenGraphDataForCitationResponse200DataOpenGraphCacheSchema")


@attr.s(auto_attribs=True)
class GetOpenGraphDataForCitationResponse200DataOpenGraphCacheSchema:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_open_graph_data_for_citation_response_200_data_open_graph_cache_schema = cls(
            page_url=page_url,
            title=title,
        ...
        get_open_graph_data_for_citation_response_200_data_open_graph_cache_schema.additional_properties = d
        return get_open_graph_data_for_citation_response_200_data_open_graph_cache_schema
