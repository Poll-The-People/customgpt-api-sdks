...
from ..models.update_project_response_200_data_project_type import UpdateProjectResponse200DataProjectType
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateProjectResponse200DataProject")


@attr.s(auto_attribs=True)
class UpdateProjectResponse200DataProject:
    """
    Attributes:
        ...
        deleted_at (Union[Unset, None, datetime.datetime]): Date and time when the project was deleted Example:
            2021-01-01 00:00:00.
        type (Union[Unset, UpdateProjectResponse200DataProjectType]): Project type Default:
            UpdateProjectResponse200DataProjectType.SITEMAP. Example: SITEMAP.
    ...
    type: Union[Unset, UpdateProjectResponse200DataProjectType] = UpdateProjectResponse200DataProjectType.SITEMAP
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, UpdateProjectResponse200DataProjectType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = UpdateProjectResponse200DataProjectType(_type)
        ...
        update_project_response_200_data_project = cls(
            id=id,
        ...
        update_project_response_200_data_project.additional_properties = d
        return update_project_response_200_data_project
