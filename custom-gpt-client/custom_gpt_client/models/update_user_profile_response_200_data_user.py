...
T = TypeVar("T", bound="UpdateUserProfileResponse200DataUser")


@attr.s(auto_attribs=True)
class UpdateUserProfileResponse200DataUser:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_user_profile_response_200_data_user = cls(
        ...
        update_user_profile_response_200_data_user.additional_properties = d
        return update_user_profile_response_200_data_user
