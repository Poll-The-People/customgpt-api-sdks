...
T = TypeVar("T", bound="GetProjectConversationMessagesResponse200MessagesLinks")


@attr.s(auto_attribs=True)
class GetProjectConversationMessagesResponse200MessagesLinks:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_project_conversation_messages_response_200_messages_links = cls(
            first=first,
            last=last,
            prev=prev,
            next_=next_,
        ...
        get_project_conversation_messages_response_200_messages_links.additional_properties = d
        return get_project_conversation_messages_response_200_messages_links
