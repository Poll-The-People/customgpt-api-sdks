...
T = TypeVar("T", bound="GetUserProfileResponse200DataUser")


@attr.s(auto_attribs=True)
class GetUserProfileResponse200DataUser:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_user_profile_response_200_data_user = cls(
        ...
        get_user_profile_response_200_data_user.additional_properties = d
        return get_user_profile_response_200_data_user
