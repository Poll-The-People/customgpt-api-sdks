...
T = TypeVar("T", bound="GetProjectConversationMessagesResponse200MessagesDataItem")


@attr.s(auto_attribs=True)
class GetProjectConversationMessagesResponse200MessagesDataItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_project_conversation_messages_response_200_messages_data_item = cls(
            id=id,
            user_id=user_id,
        ...
        get_project_conversation_messages_response_200_messages_data_item.additional_properties = d
        return get_project_conversation_messages_response_200_messages_data_item
