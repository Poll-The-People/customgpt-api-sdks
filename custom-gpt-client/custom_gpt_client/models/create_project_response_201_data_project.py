...
from ..models.create_project_response_201_data_project_type import CreateProjectResponse201DataProjectType
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateProjectResponse201DataProject")


@attr.s(auto_attribs=True)
class CreateProjectResponse201DataProject:
    """
    Attributes:
        ...
        deleted_at (Union[Unset, None, datetime.datetime]): Date and time when the project was deleted Example:
            2021-01-01 00:00:00.
        type (Union[Unset, CreateProjectResponse201DataProjectType]): Project type Default:
            CreateProjectResponse201DataProjectType.SITEMAP. Example: SITEMAP.
    ...
    type: Union[Unset, CreateProjectResponse201DataProjectType] = CreateProjectResponse201DataProjectType.SITEMAP
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, CreateProjectResponse201DataProjectType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = CreateProjectResponse201DataProjectType(_type)
        ...
        create_project_response_201_data_project = cls(
            id=id,
        ...
        create_project_response_201_data_project.additional_properties = d
        return create_project_response_201_data_project
