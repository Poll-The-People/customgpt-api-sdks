...
T = TypeVar("T", bound="CreateProjectConversationResponse201DataConversation")


@attr.s(auto_attribs=True)
class CreateProjectConversationResponse201DataConversation:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_project_conversation_response_201_data_conversation = cls(
        ...
        create_project_conversation_response_201_data_conversation.additional_properties = d
        return create_project_conversation_response_201_data_conversation
