...
T = TypeVar("T", bound="GetProjectConversationMessagesResponse200Conversation")


@attr.s(auto_attribs=True)
class GetProjectConversationMessagesResponse200Conversation:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_project_conversation_messages_response_200_conversation = cls(
        ...
        get_project_conversation_messages_response_200_conversation.additional_properties = d
        return get_project_conversation_messages_response_200_conversation
